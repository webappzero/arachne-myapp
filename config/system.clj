...
(core/component :arachne-demo-1/status
  {:arachne-demo-1/ticktock :data-source}
  'arachne-demo-1.web/->StatusHandler)

(http/server :arachne-demo-1/server 8080

  (http/endpoint :get "/status" :arachne-demo-1/status)
